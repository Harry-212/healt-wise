...
export function buildLocationFaq(loc: UkWeightLossLocation): FaqItem[] {
  ...
  if (loc.slug === "birmingham") {
    return [
      ...
      },
      {
        ...
        a: `There is no single best for everyone, but evidence supports certain medicines for eligible people alongside lifestyle changes. Our [UK comparator](/compare/wegovy-vs-mounjaro) maps options and what to check before you pay.`,
      },
      {
      ...
      },
      {
        ...
        a: `They vary by service and eligibility. Many routes begin with lifestyle and dietitian support, and specialist options may have capacity limits. If you consider private routes, compare follow up and safety using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `For many eligible people, prescription injections can drive meaningful average loss when supervised, especially when paired with food and movement habits. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro), then read [Mounjaro](/what-is-mounjaro) and [Wegovy](/what-is-wegovy). Compare ongoing costs using [Mounjaro prices](/mounjaro-price-comparison) and [Wegovy prices](/wegovy-price-comparison).`,
      },
      {
        q: "How did Kelly Clarkson lose weight so quickly?",
      ...
      },
      {
        ...
        a: `NHS routes usually begin via your GP and may include tiered support, assessments, dietitian input, and specialist referral for eligible people. Availability and waiting times vary. If you compare private routes, use [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) to evaluate safety and follow up, not just speed.`,
      },
      {
    ...
    return [
      {
        ...
        a: `Many people do best with a layered plan: NHS behaviour support plus food structure, walking and strength, and medication for eligible people. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro), then read [what Wegovy is](/what-is-wegovy) and [what Mounjaro is](/what-is-mounjaro).`,
      },
      {
      ...
      },
      {
        ...
        a: `There is no single best for everyone. Evidence supports certain medicines for eligible people, but NHS behaviour services suit many people first. Use our [UK comparator](/compare/wegovy-vs-mounjaro) to understand options and what to check before paying.`,
      },
      {
  ...
  if (loc.slug === "bournemouth") {
    return [
      ...
      },
      {
        ...
        a: `There is no single best for everyone, but evidence supports certain prescription medicines for eligible people. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro), then review [Wegovy](/what-is-wegovy) and costs on [Wegovy prices](/wegovy-price-comparison).`,
      },
      {
    ...
    return [
      {
        ...
        a: `For eligible people, medicines like [Wegovy](/what-is-wegovy) and [Mounjaro](/what-is-mounjaro) can drive large average loss in trials, but most people do better when medication is paired with food structure, steps, and strength. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
  ...
  if (loc.slug === "brighton-and-hove") {
    return [
      {
        q: "Most successful weight loss treatment?",
        a: `For eligible people, GLP 1 medicines can drive strong average loss, but results are usually best when you pair injections with food structure, steps, and strength. Start at [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro), then read [what Wegovy is](/what-is-wegovy) and [what Mounjaro is](/what-is-mounjaro).`,
      },
      {
  ...
  if (loc.slug === "cambridge") {
    return [
      ...
      },
      {
        ...
        a: `NHS routes can be free for eligible people but waiting times and criteria vary. Private routes can be faster but cost more. Use [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) to compare safety, follow up, and total cost.`,
      },
    ];
  }
  ...
  if (loc.slug === "canterbury") {
    return [
      {
        q: "What is the most successful weight loss treatment?",
        a: `GLP 1 medicines like [Wegovy](/what-is-wegovy) and [Mounjaro](/what-is-mounjaro) can drive strong average loss for eligible people, but supervised use with habits helps sustainability. See [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) to compare options.`,
      },
      {
  ...
  if (loc.slug === "cardiff") {
    return [
      ...
      },
      {
        ...
        a: `NHS routes can be lower cost but criteria and waiting times vary. Private routes can be quicker but pricier. Use the [UK comparator](/compare/wegovy-vs-mounjaro) to compare safety and follow up, not just speed.`,
      },
      {
  ...
  if (loc.slug === "carlisle") {
    return [
      {
        q: "What is the most successful weight loss treatment?",
        a: `Sustainable lifestyle shifts often lead long term outcomes, and medicines can add extra loss for eligible people when supervised. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro), then read [what Mounjaro is](/what-is-mounjaro) and [what Wegovy is](/what-is-wegovy).`,
      },
      {
        q: "How did Kelly Clarkson lose weight so quickly?",
  ...
  if (loc.slug === "chelmsford") {
    return [
      {
        q: "Most successful weight loss treatment?",
        a: `For many people, lifestyle changes sustain long term results, while medicines can add extra loss for eligible people when supervised. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro), then read [what Wegovy is](/what-is-wegovy) and [what Mounjaro is](/what-is-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `For eligible people, medicines like [Wegovy](/what-is-wegovy) and [Mounjaro](/what-is-mounjaro) can drive strong average loss in trials, but outcomes are usually best when paired with food structure, steps, and strength. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `Some trials show strong average loss for eligible people on medicines like [Mounjaro](/what-is-mounjaro), but sustainability still depends on habits. Start at [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and compare options safely.`,
      },
      {
  ...
  if (loc.slug === "coventry") {
    return [
      {
        q: "Most successful weight loss treatment overall?",
        a: `For eligible people, medicines like [Wegovy](/what-is-wegovy) and [Mounjaro](/what-is-mounjaro) can drive strong average loss in trials, but long term outcomes are usually best when paired with food structure, steps, and strength. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `Availability can be limited and pathways vary. If you are considering private or pharmacy routes, prioritise regulation and follow up. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and use [our methodology](/methodology) to compare providers safely.`,
      },
      {
    ...
    return [
      {
        ...
        a: `Many clinic pathways emphasise supervised injection medicines for eligible people, but sustainability still depends on habits. Start with [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and read [what Mounjaro is](/what-is-mounjaro) and [what Wegovy is](/what-is-wegovy).`,
      },
      {
  ...
  if (loc.slug === "dunfermline") {
    return [
      ...
      },
      {
        ...
        a: `Access is usually reserved for specific eligibility criteria and severe cases, with clinician assessment and waiting lists. If you are exploring options, compare NHS pathways with private programs using our [best weight loss treatments in the UK guide](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `A safer pace is often around 0.5 to 1 kg per week through a consistent calorie deficit and activity. A 7 day target is typically unsafe for fat loss and can reflect water and muscle loss. If you want a structured comparison of options, start at [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `Yes. Many people start with NHS dietitian or group programs via GP referral. Medicines may be considered after assessment and eligibility checks. Compare routes using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
  ...
  if (loc.slug === "ely") {
    return [
      {
        q: "Most successful treatment?",
        a: `Many people do best with a structured behavioural program plus habits they can maintain. In Ely, Healthy You style support is often a strong first step, with GLP 1 medicines considered for eligible people. Compare options using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
  ...
  if (loc.slug === "exeter") {
    return [
      ...
      },
      {
        ...
        a: `Some people compare daily liraglutide options with weekly pens, but the cheapest route can be an NHS lifestyle program if you qualify. Compare options using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `Structured support plus habits you can maintain often wins long term. In Glasgow, NHSGGC pathways can provide a free foundation, and GLP 1 medicines may be an add on for eligible people. Compare options using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `For many people, a structured NHS lifestyle program plus repeatable habits is the most reliable base. If you are comparing options, start at [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and check follow up quality using [our methodology](/methodology).`,
      },
      {
    ...
    return [
      {
        ...
        a: `For many people, the best starting point is an NHS lifestyle program with coaching and accountability. Use [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) to compare options and [our methodology](/methodology) to check follow up quality.`,
      },
      {
    ...
    return [
      {
        ...
        a: `Yes. Kirklees Wellness style services often offer free coaching for eligible adults. Start by comparing your options using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and prepare for eligibility chats with the [BMI calculator](/tools/bmi-calculator).`,
      },
      {
    ...
    return [
      {
        ...
        a: `Many people start with local dietetic or community weight management routes. Availability changes over time, but an NHS pathway with coaching can be a strong first step. Compare approaches using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
  ...
  if (loc.slug === "leicester") {
    return [
      ...
      },
      {
        ...
        a: `Yes, for eligible people in trials and clinics when GLP 1 medicines pair with structured exercise and nutrition and monitoring stays tight. Compare safety and follow up using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and [our methodology](/methodology).`,
      },
      {
  ...
  if (loc.slug === "lichfield") {
    return [
      ...
      },
      {
        ...
        a: `Fat freezing style devices and local lipolysis providers can target small areas, while Slimming World style groups add accountability. Pair any device route with food skills and steps. Compare overall treatment types using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
    ];
  }
    ...
    return [
      {
        ...
        a: `No. A maximum safe rate is often quoted near 12 kg over 12 weeks at about 1 kg weekly for some monitored people, but individual limits vary. Faster paces risk high muscle loss and rebound. NHS tier 3 style programmes often target sustainable trajectories closer to about 15 kg over 6 months in selected cohorts. Read [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and [methodology](/methodology).`,
      },
      {
  ...
  if (loc.slug === "manchester") {
    return [
      ...
      },
      {
        ...
        a: `For severe obesity, surgery can be more effective and more durable. For many people, however, GLP 1 medication is a less invasive first step. Compare overall pathways using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `For many people, the strongest non-surgical option is a medically supervised GLP 1 programme combined with lifestyle change. For more severe obesity, surgery can be the most powerful option. Compare the main routes using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `Combination programs with NICE-backed diet, exercise, and GLP 1 medicines such as Wegovy or Mounjaro can yield 10-20% loss long-term for eligible patients, while fads often fail long run. Compare the main routes using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
        q: "How did Kelly Clarkson really lose her weight?",
  ...
  if (loc.slug === "merthyr-tydfil") {
    return [
      ...
      },
      {
        ...
        a: `Cryolipolysis (fat freezing, 21% per zone, 35-min sessions). Ultrasound close second. Combine with diet for 30% better results. If appetite control is also part of the problem, compare broader pathways on [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro).`,
      },
      {
    ...
    return [
      {
        ...
        a: `NHS dietitian led tier 2 and tier 3 programmes often win on cost and follow up, with about 10% loss bands in NICE aligned summaries plus group support. Trials still show about 70% maintenance narratives post year one only when habits stick. Compare pathways using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and read [methodology](/methodology).`,
      },
      {
    ...
    return [
      {
        ...
        a: `No. Healthwise360 is a London-based provider-comparison and educational website. It does not prescribe, dispense or deliver medicines. Compare providers using the [UK weight loss treatment comparison](/compare/wegovy-vs-mounjaro) and [methodology](/methodology).`,
      },
      {
    ...
    return [
      {
        ...
        a: `The most successful approach is usually a medically supervised plan that combines nutrition, physical activity, behaviour change, and, when appropriate, prescription medication. Structured plans tend to beat willpower alone. Compare pathways using [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) and read [methodology](/methodology).`,
      },
      {
  ...
  if (loc.slug === "bangor-northern-ireland") {
    return [
      ...
      },
      {
        ...
        a: `They can sharpen awareness, but most people still need real-world movement and a food environment that makes the deficit plausible. Pair apps with walking the coast and structured medical support if you qualify—start from [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) when you want the full comparator view.`,
      },
    ];
  }
  ...
  if (loc.slug === "bangor-wales") {
    return [
      ...
      },
      {
        ...
        a: `Often yes when they support habits rather than shame. Pair apps with real steps and structured medical follow up if you qualify. Start from [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) when you want the full comparator picture, and read [our methodology](/methodology) for how we review providers.`,
      },
    ];
  }
  ...
  if (loc.slug === "basildon") {
    return [
      ...
      },
      {
        ...
        a: `Either works; groups add accountability for many people. Start from [best weight loss treatments in the UK](/compare/wegovy-vs-mounjaro) when you want the full comparator view, then add community walks or apps that reward consistency, not shame.`,
      },
    ];
  }
