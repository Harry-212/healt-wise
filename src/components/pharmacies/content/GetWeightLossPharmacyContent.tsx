...
export default function GetWeightLossPharmacyContent() {
  ...
  return (
    <PharmacyDossierPage
      ...
      title="GetWeightLoss weight management review"
      subtitle="Independent provider review of GetWeightLoss: consultation process, clinical support, registered pharmacy fulfilment, delivery fees, treatment prices and total monthly cost (information only — not medical advice)."
