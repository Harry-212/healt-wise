...
export default function GetADripPharmacyContent() {
  ...
  return (
    <PharmacyDossierPage
      ...
      title="Get A Drip weight management review"
      subtitle="Independent provider review of Get A Drip: consultation process, clinical support, registered pharmacy fulfilment, delivery fees, treatment prices and total monthly cost (information only — not medical advice)."
