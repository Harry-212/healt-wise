...
export default function Shape8PharmacyContent() {
  ...
  return (
    <PharmacyDossierPage
      ...
      title="Shape8 weight management review"
      subtitle="Independent provider review of Shape8: consultation process, clinical support, registered pharmacy fulfilment, delivery fees, treatment prices and total monthly cost (information only — not medical advice)."
