  ...
  return (
    ...
    >
      <section className="space-y-4">
        <div className="mb-6 rounded-xl border border-indigo-100 bg-indigo-50/50 p-5 shadow-sm"><p className="text-slate-800 leading-relaxed"><strong className="text-indigo-900">Service Profile:</strong> Happy Pharmacy operates as a regulated UK online pharmacy giving patients access to prescription weight loss medication. Since treatment needs vary so much from person to person, it's worth understanding how Happy Pharmacy runs its consultations, delivers medication and prices its plans before choosing a provider.</p></div>
