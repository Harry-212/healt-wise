        ...
        <thead>
          <tr className="bg-slate-900 text-white">
            ...
            {PEN_STRENGTHS.map((pen) => (
              <th
                key={pen}
                className="border-b border-slate-700 px-4 py-3 font-semibold text-center"
              >
                {pen}mg Pen
              </th>
            ))}
...
export default function MounjaroClickCalculatorClient() {
  ...
  const clicks = useMemo(
    () => calculateClicks(penStrength, desiredDose),
    ...
    <div className="relative w-full overflow-x-clip">
      ...
      <section className="sticky top-0 z-0 flex min-h-[85vh] flex-col">
        <div className="relative flex min-h-[85vh] flex-1 flex-col">
          ...
          />
          <div
            className="absolute inset-0 bg-linear-to-b from-violet-950/90 via-violet-950/85 to-slate-950/95"
            aria-hidden
          />
                    ...
                    <div className="space-y-6">
                      <div>
                        <label className="text-sm font-medium text-slate-700">
                          1. Your Pen Strength (mg)
                        </label>
                        <p className="text-xs text-slate-500 mt-1 mb-3">
                          Select the Mounjaro pen you currently have.
                        </p>
                      ...
                      <div>
                        ...
                        <div className="mt-3 flex flex-wrap gap-1.5">
                          <span className="text-[0.65rem] font-semibold uppercase text-slate-400 mt-1 mr-1">
                            Common:
                          </span>
                        ...
                        <div className="flex items-start gap-2.5">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-xs leading-relaxed text-amber-800">
                              Adjusting your Mounjaro dose by counting clicks is
                              considered off-label use. Always consult your
                              prescriber before changing your dosage protocol.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        >
                          <div className="rounded-2xl bg-slate-900 p-6 text-white shadow-xl ring-1 ring-slate-800 relative overflow-hidden">
                            ...
                            <div className="mt-8 rounded-xl bg-white/10 p-4 backdrop-blur-sm border border-white/10">
                              <p className="text-xs font-semibold uppercase tracking-wider text-violet-200/80 mb-2">
                                The Math
                              </p>
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="mt-1 text-sm leading-relaxed text-orange-700">
                                    A single Mounjaro KwikPen dose is physically
                                    limited to 60 clicks. To achieve {clicks}{" "}
                                    clicks, you will need to inject a full
                                    60-click dose, then dial an additional{" "}
                                    {clicks - 60} clicks for a second injection.
                                  </p>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="flex flex-wrap gap-2 pt-2">
                            <Link
                              ...
                              className="inline-flex min-h-10 items-center gap-1.5 rounded-full bg-violet-600 px-5 text-sm font-semibold text-white transition hover:bg-violet-700 shadow-sm"
                            >
                              Compare GLP-1s{" "}
                              <Zap
                  ...
                  >
                    <div className="max-w-3xl">
                      <h2 className="text-2xl font-bold text-slate-900">
                        Mounjaro KwikPen Clicks Chart
                      </h2>
                      <p className="mt-2 text-slate-600">
                        Use this reference chart to quickly find the exact
                        number of clicks needed for your desired dose across all
                        available UK Mounjaro pen strengths.
                      </p>
                    </div>
                    ...
                    <div className="rounded-xl bg-slate-50 border border-slate-200 p-5 mt-4 max-w-3xl">
                      ...
                      <ul className="mt-2 list-disc list-inside text-sm text-slate-700 space-y-1.5">
                        ...
                        <li>
                          Look across to the column that matches your current
                          Pen Strength.
                        </li>
                        <li>
                          The intersecting number is the total clicks you need
                          to dial.
                        </li>
                        <li>
