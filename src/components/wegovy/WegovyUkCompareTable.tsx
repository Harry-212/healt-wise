                      ...
                      >
                        <div className="flex flex-col gap-1.5">
                          {linkProfile ? (
                            <Link
                              href={profile}
                              className="block max-w-20 whitespace-normal wrap-break-word font-semibold leading-snug text-teal-800 underline decoration-teal-300/70 underline-offset-2 transition hover:text-teal-950 hover:decoration-teal-600 sm:max-w-26"
                            >
                              {p.name}
                            </Link>
                          ) : (
