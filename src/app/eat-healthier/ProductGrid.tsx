...
import breakfastLunchBundle from "../../../public/blog/Breakfast_Lunch_UK.png";
import dailyGreens from "../../../public/FeatureProductImg_DailyGreens.png";
import dailyGreensHover from "../../../public/FeatureProductImg_DailyGreens_Hover.png";
import wellnessSet from "../../../public/Wellness_Bundle_UK-NEW.png";
...
const PRODUCTS: Product[] = [
  ...
  {
    id: "breakfast-lunch-bundle",
    name: "Breakfast & Lunch Bundle",
    description: "Two meals. Zero guesswork.",
    specs: [
      "Our Black Edition and Hot & Savory meals",
      "Free T-shirt and shaker",
    ],
    price: "From £37.85",
    image: breakfastLunchBundle,
    buyHref: "https://uk.huel.com/products/breakfast-lunch-bundle",
    discountCode: "HEALTHWISE360",
  },
  {
    id: "daily-greens",
    ...
    badgeTone: "bestseller",
    name: "Daily Greens",
    description: "Supergreens powder",
    specs: ["91 vitamins, minerals & nutrients", "23 kcal per serve"],
    price: "From £45",
    pricePer: "£1.50 per serving",
    image: dailyGreens,
    hoverImage: dailyGreensHover,
    buyHref: "https://uk.huel.com/products/huel-daily-greens",
    discountCode: "HEALTHWISE360",
  },
  {
    id: "daily-wellness-set",
    name: "Daily Wellness Set",
    description: "Because balance should be easy",
    specs: [
      "Our Daily Greens and lighter ready-to-go products",
      "Free Daily Greens bottle",
    ],
    price: "From £62.50",
    image: wellnessSet,
    buyHref: "https://uk.huel.com/products/daily-wellness-set",
    discountCode: "HEALTHWISE360",
  },
  {
    id: "huel-diet",
