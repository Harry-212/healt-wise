      ...
      <div className="mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 sm:pt-10 md:pt-12 lg:px-8">
        ...
        {/* CONTENT SPLIT LAYOUT */}{/* LEFT: TOC */}{/* RIGHT: ARTICLE BODY */}<article className={`space-y-8 leading-relaxed ${darkMode ? "text-slate-300" : "text-slate-700"}`}>
              ...
              <p className="text-lg md:text-xl">
                You may have seen tirzepatide, sold under the brand name Mounjaro, generating buzz lately as a promising diabetes medication that some people also use off label for significant weight reduction. But how does Mounjaro work for weight loss, and is it right for you? Before jumping in, it is helpful to understand its effects on your body, potential side effects, and the importance of pairing any medical treatment with healthy lifestyle choices.</p>
              <p>
