      ...
      <div className="mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 sm:pt-10 md:pt-12 lg:px-8">
        ...
        {/* CONTENT SPLIT LAYOUT */}{/* LEFT: TOC */}{/* RIGHT: ARTICLE BODY */}<article className={`space-y-8 leading-relaxed ${darkMode ? "text-slate-300" : "text-slate-700"}`}>
              ...
              <GuideSection darkMode={darkMode} id="purpose" heading="Understand Mounjaro’s Purpose">
                <p>
                  Mounjaro, known by its generic name tirzepatide, is a medication originally approved to help adults with type 2 diabetes manage their blood sugar levels. Its unique formulation targets two different hormone receptors to regulate appetite, slow digestion, and enhance insulin function [1]. Although its primary purpose is diabetes control, many people are also curious about its potential for weight management.</p>
                <p>
