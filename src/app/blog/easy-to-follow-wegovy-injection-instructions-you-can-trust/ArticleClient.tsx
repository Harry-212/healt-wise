      ...
      <div className="mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 sm:pt-10 md:pt-12 lg:px-8">
        ...
        {/* CONTENT SPLIT LAYOUT */}{/* LEFT: TOC */}{/* RIGHT: ARTICLE BODY */}<article className={`space-y-8 leading-relaxed ${darkMode ? "text-slate-300" : "text-slate-700"}`}>
              ...
              <GuideSection darkMode={darkMode} id="prepare" heading="Prepare For Each Weekly Injection">
                ...
                <p>
                  Start by checking that you have the right pen and dose, especially during dose escalation. Look through the pen window to ensure the liquid is clear and colourless. If it looks cloudy, has particles, or has changed colour, do not use it and contact your pharmacy or clinician.</p>
                <p>
