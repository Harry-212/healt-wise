      ...
      <div className="mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 sm:pt-10 md:pt-12 lg:px-8">
        ...
        {/* CONTENT SPLIT LAYOUT */}{/* LEFT: TOC */}{/* RIGHT: ARTICLE BODY */}<article className={`space-y-8 leading-relaxed ${darkMode ? "text-slate-300" : "text-slate-700"}`}>
              ...
              <GuideSection darkMode={darkMode} id="dosage-works" heading="How Mounjaro Dosage For Weight Loss Works">
                ...
                <p>
                  The dose escalation method helps manage nausea, constipation, and other gastrointestinal (GI) issues by not overwhelming your system too quickly. That said, everyone’s response is unique. You may find that 7.5 mg is enough to reach your goals, or you may discuss moving up to 10 mg if you hit a plateau.</p>
              </GuideSection>
              ...
              <GuideSection darkMode={darkMode} id="long-term" heading="Long-Term Success Strategies">
                ...
                <p>
                  Because your body evolves alongside each dosage, you will want to reconnect with your GP periodically. Regular check ins can confirm you are still on the right dose or identify if you have plateaued. Armed with medical insights and a sensible routine, you can improve your likelihood of success and keep your weight off even after you finish your Mounjaro journey.</p>
              </GuideSection>
