...
const TOC = [
  ...
  { id: "dosing-pricing", label: "Dosing and pricing" },
  {
    ...
    label: "Side effects and potential health benefits",
  },
        ...
        <BlogArticleColumn toc={TOC} darkMode={darkMode}>
          ...
          >
            <GuideSection
              darkMode={darkMode}
              id="understand-pens"
              heading="Understand weight loss pens"
            >
              <p className="text-lg md:text-xl">
                Weight loss pens have become much more mainstream in the UK. A
                few years ago, many people had never heard of them. Now they
                come up in GP appointments, news stories, and probably in
                conversations with friends who have tried everything from
                calorie counting to meal replacements.
              </p>
            ...
            <GuideSection
              darkMode={darkMode}
              id="how-they-work"
              heading="How these pens work"
            >
              <p>
                Most weight loss pens work through incretin hormones,
                particularly GLP-1, and in some cases GIP as well.
              </p>
              ...
              <p>
                ...
                help reduce appetite but may also explain common side effects
                like nausea.
              </p>
              ...
              <p>
                Some users may see significant weight reduction over time,
                particularly when injections are paired with sustained lifestyle
                changes.
              </p>
            ...
            >
              ...
              <p>
                ...
                point in obesity treatment.
              </p>
              <p>
                Some higher dose studies suggest substantial results, in some
                cases approaching 20 percent or more.
              </p>
              ...
              <p>
                Mounjaro is often discussed as the most potent option currently
                available.
              </p>
              <p>
                Some evidence suggests average reductions up to 22.5 percent in
                some settings.
              </p>
              ...
              <p>
                Because stronger does not automatically mean better for every
                person.
              </p>
            ...
            >
              ...
              <p>
                Sometimes the &ldquo;best&rdquo; pen is simply the one you can
                stay on consistently.
              </p>
            ...
            >
              ...
              <p>
                Stopping because of cost may affect results just as much as
            ...
            >
              ...
              <p>
                Rare complications, including pancreatitis or gallbladder
                issues, may also need discussion.
              </p>
              <p>
                On the positive side, some research suggests broader metabolic
                or cardiovascular benefits may exist in some groups.
              </p>
            ...
            >
              ...
              <p>
                People often overlook it, and then struggle to explain why they
                suddenly feel worse at dose changes.
              </p>
            ...
            >
              <div className="space-y-8">
                <div>
                  ...
                  <p>
                    At the moment, Mounjaro is often viewed as the most
                    effective prescription weight loss pen available in the UK,
                    at least based on current comparative trial data. Some
                    studies suggest average weight reduction of around 20
                    percent with Mounjaro, compared with roughly 14 percent for
                    Wegovy under similar study conditions. That said,
                    &ldquo;most effective&rdquo; can be misleading—effectiveness
                    may depend on total weight lost, appetite control,
                    tolerability, cost, or long-term maintenance.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    ...
                    used, though it works very differently from injections. Some
                    clinicians may discuss other medicines depending on the
                    case. Injectable therapies often appear stronger in overall
                ...
                <div>
                  ...
                  <p>
                    The 3 3 3 rule is generally a behavioural framework, not a
                    clinical obesity treatment model. It often refers to 3
                    balanced meals, 30 minutes movement, and reducing 3 high
                    calorie trigger foods. It may help some people simplify
                    habits. It should not be mistaken for a medical protocol.
                  </p>
                </div>
                <div>
                  <h3
            ...
            >
              <div className="space-y-8">
                <div>
                  ...
                  <p>
                    No. Not universally. They require individual assessment.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    Yes. These medicines require proper prescribing and should
                    not be sourced informally.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    Current evidence often favours Mounjaro, though individual
                    response varies.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Possibly months. Sometimes longer. Progress reviews often
                    guide duration.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Discuss them early. Do not just &ldquo;push through&rdquo;
                    severe symptoms without advice.
                  </p>
                </div>
                <div>
                  <h3
            ...
            >
              <p>
                Comparing UK weight loss pens is not really about finding a
                winner on paper.
              </p>
              ...
              <p>
                If I were weighing options personally, I would probably ask:
              </p>
              ...
              <p>
                Those questions may matter more than chasing the highest
                percentage in a headline.
              </p>
              <p
            ...
            <ArticleSources slug="how-to-compare-uk-weight-loss-pens-and-find-the-best" darkMode={darkMode} />
          </article>
