          ...
          >
            ...
            >
              <p className="text-lg md:text-xl">
                ...
                support, or a non-injection alternative to GLP-1 weight loss
                treatment.
              </p>
              <p>
                However, the safest decision is not simply choosing the lowest
                price. A good weight loss treatment should be legal, clinically
                suitable, supplied by a registered pharmacy, and matched to your
                health profile.
              </p>
              <p>
            ...
            >
              ...
              <p>
                For example, the NHS explains that orlistat is used to treat
                obesity and can be available as prescription Xenical or at a
                lower dose as Alli or Orlos from a pharmacy. It also notes that
                orlistat should be bought from a registered pharmacy because
              ...
              <ul className="list-disc space-y-3 pl-5">
                ...
                <li>
                  Whether the treatment suits your BMI and medical history
                </li>
            ...
            >
              ...
              <ul className="list-disc space-y-3 pl-5">
                ...
                <li>
                  New oral GLP-1 tablets, such as semaglutide tablets approved
                  for weight management
                </li>
                <li>
                  Non-prescription slimming aids, which are usually not the same
                  as regulated obesity medicines
                </li>
              </ul>
              <p>
            ...
            >
              ...
              <p>
                Orlistat is one of the most established oral weight loss
                medicines in the UK. It works by reducing how much fat is
                absorbed by the body. According to the NHS, around a third of
                the fat from food is passed out instead of being absorbed.
              </p>
              <p>
                Orlistat is usually considered when someone has a BMI of 30 or
                above, or a BMI of 28 or above with a weight-related condition
                such as high blood pressure or type 2 diabetes. However,
                eligibility can vary depending on whether you are using NHS
                services or a private provider.
              </p>
              <p>
                One reason people compare orlistat is price. It is often cheaper
                than GLP-1 injections, especially at entry level. However, it
                may not suit everyone because it is linked to digestive side
                effects and must be used with a suitable diet.
              </p>
              <p>
                For Healthwise360 users, this is where a weight loss treatment
                price comparison becomes useful. Comparing orlistat should
                include the number of capsules, the treatment duration,
                consultation fees, and whether the provider offers follow-up
                support. You can start on the homepage to{" "}
                <Link
                  href="/"
                  className="font-medium text-emerald-600 hover:underline"
                >
                ...
                across providers before you commit to one option.
              </p>
              ...
              <p>
                ...
                pharmacy, but users should check the medicine leaflet and speak
                to a pharmacist or doctor if unsure.
              </p>
              <p>
              ...
              <p>
                Mysimba is a prescription weight management tablet containing
                naltrexone and bupropion. The European Medicines Agency explains
                that it is used with diet and exercise to help manage weight in
                adults with obesity, or overweight adults with weight-related
                complications.
              </p>
              <p>
                Unlike orlistat, Mysimba does not work mainly by reducing fat
                absorption. Instead, it acts on areas involved in appetite and
                food intake. Therefore, it is often compared by people who want
                tablet-based appetite support.
              </p>
              <p>
                However, Mysimba is not suitable for everyone. Because it
                contains active medicines that may interact with health
                conditions or other medicines, it requires proper clinical
                assessment.
              </p>
              <p>
                When comparing Mysimba prices, do not only look at the
                first-month cost. Instead, check whether the provider includes
                clinical review, follow-up, delivery, and guidance on what
                happens if the treatment is not suitable. For a deeper look at
                how one major provider handles weight loss treatment, read our{" "}
                <Link
                  href="/pharmacies/zava"
                  className="font-medium text-emerald-600 hover:underline"
                >
                  Zava weight loss review
                </Link>
                .
              </p>
              ...
              <p>
                ...
                are overweight with at least one weight-related comorbidity. It
              ...
              <p>
                The MHRA explains that the semaglutide tablet should be taken on
                an empty stomach after fasting, with no food or drink for at
                least 30 minutes after taking it. It is also not currently
                available through the NHS at the time of the MHRA announcement.
              </p>
              <p>
            ...
            >
              ...
              <p>However, injections may appeal if you:</p>
              <ul className="list-disc space-y-3 pl-5">
              ...
              <p>
                However, convenience is personal. A weekly injection may be
                easier for one person, while a daily tablet may feel simpler for
                someone else.
              </p>
              <p>
                Therefore, the smarter question is not &ldquo;Which is
                best?&rdquo; but &ldquo;Which weight loss treatment fits my
            ...
            >
              ...
              <p>
                Orlistat is often one of the lower-cost prescription options.
                Meanwhile, Mysimba may cost more because it is a different type
                of prescription tablet. Newer oral GLP-1 tablets may sit closer
                to GLP-1 pricing, although real-world private prices can vary as
                availability develops.
              </p>
              <p>
                When comparing weight loss price, always check whether the price
                includes:
              </p>
              <ul className="list-disc space-y-3 pl-5">
              ...
              <p>
                For example, a provider may advertise a low starting price, but
                the total monthly cost may be higher once consultation,
                delivery, or follow-up is included. Besides that, some
                treatments may require review after a set period, which affects
            ...
            <GuideSection
              darkMode={darkMode}
              id="compare-price"
              heading="How to Compare Weight Loss Treatment Price Properly"
            >
              <p>
                A strong comparison should not only ask, &ldquo;Which provider
                is cheapest?&rdquo;
              </p>
              <p>Instead, ask:</p>
              <ul className="list-disc space-y-3 pl-5">
                <li>
                  <strong className="font-semibold">
                    What medicine is included?
                  </strong>{" "}
                  Orlistat, Alli, Mysimba, or semaglutide tablets are not the
                  same.
                </li>
                <li>
                  <strong className="font-semibold">
                    What strength or dose is being compared?
                  </strong>{" "}
                  A lower-dose option may look cheaper but may not be
                  equivalent.
                </li>
                <li>
                  <strong className="font-semibold">
                  ...
                  Capsule count matters when comparing real cost.
                </li>
                <li>
                  <strong className="font-semibold">
                    Is consultation included?
                  </strong>{" "}
                  Some online doctors include assessment in the treatment price,
                  while others may separate costs.
                </li>
                <li>
                  <strong className="font-semibold">
                    Is the pharmacy registered?
                  </strong>{" "}
                  Safety should come before price.
                </li>
                <li>
                  <strong className="font-semibold">
                    What happens after the first month?
                  </strong>{" "}
                  Some treatments involve reviews, dose changes, or repeat
                  prescription checks.
                </li>
                <li>
                  <strong className="font-semibold">
                    Is lifestyle support included?
                  </strong>{" "}
                  Weight loss treatment usually works best when combined with
                  diet, activity, and support.
                </li>
              </ul>
              <p>
            ...
            >
              ...
              <p>
                The NHS specifically warns that there are websites selling fake
                weight loss medicines and says private orlistat should be bought
                from a registered pharmacy.
              </p>
              <p>
                Therefore, before buying any weight loss treatment online,
                check:
              </p>
              <ul className="list-disc space-y-3 pl-5">
                <li>
                ...
                <li>
                  The medicine is not being sold casually through social media
                </li>
            ...
            >
              <p>
                ...
                weight loss treatments are linked to BMI and weight-related
                health risks.
              </p>
              <p>
                For orlistat, the NHS says it is usually prescribed for adults
                with a BMI of 30 or more, or 28 or more with a weight-related
                condition.
              </p>
              <p>
                For Mysimba, the EMA describes use in adults with obesity or
                overweight adults with weight-related complications, alongside
                diet and exercise.
              </p>
              <p>
                For semaglutide tablets, the MHRA says the treatment may be
                prescribed to adults with obesity, or adults who are overweight
                with at least one weight-related comorbidity.
              </p>
              <p>
                However, BMI is only part of the decision. A clinician may also
                consider:
              </p>
              <ul className="list-disc space-y-3 pl-5">
                <li>Age</li>
              ...
              <p>
                Therefore, an online questionnaire is not just a formality. It
                is part of the safety process. Once you know your likely
                category, using our{" "}
                <Link
            ...
            >
              ...
              <p>
                However, these are not the same as regulated weight loss
                medicines.
              </p>
              <p>
                ...
                oversight, or medical suitability checks.
              </p>
              <p>We separate the two clearly:</p>
              <ul className="list-disc space-y-3 pl-5">
                <li>
                  Weight loss medicines are regulated treatments used for
                  obesity or weight management.
                </li>
                <li>
                  Weight loss supplements are wellness products and may not be
                  suitable for medical weight management.
                </li>
                <li>
                  Fat loss results usually depend on a calorie deficit,
                  long-term behaviour change, and medical support where
                  appropriate.
                </li>
              </ul>
              <p>
            ...
            <GuideSection
              darkMode={darkMode}
              id="comparison-table"
              heading="Suggested Comparison Table"
            >
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p>
                    ...
                    sellers, and offers that skip medical assessment.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    ...
                    looking for an oral GLP-1 option.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    ...
                    starting price than GLP-1 injections. However, the total
                    weight loss treatment price depends on pack size, provider
                    fees, delivery, follow-up, and how long the treatment
                    continues.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Lower-dose orlistat products such as Alli or Orlos may be
                    available from a pharmacy. However, prescription-strength
                    options such as Xenical or prescription orlistat usually
                    require a private or NHS prescription.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    No. Orlistat mainly reduces fat absorption from food, while
                    Mysimba acts on appetite and food intake pathways.
                    Therefore, the right choice depends on your health profile,
                    eating habits, suitability, and clinical review.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    ...
                    weight management in the UK on 11 June 2026. However, it is
                    prescription-only and availability may depend on private
                    providers and future NHS decisions.
                  </p>
                </div>
                <div>
                  <h3
                  ...
                  <p>
                    ...
                    medicines. They should not be treated as equal to
                ...
                <div>
                  ...
                  <p>
                    ...
                    active ingredient, treatment suitability, side effects,
                    total cost, delivery fees, and follow-up support. Also, use
                    a BMI calculator before comparing treatment options.
                  </p>
                </div>
              </div>
            </section>
            ...
            >
              ...
              <p>
                For some adults, orlistat may be a practical and lower-cost
                starting point. For others, Mysimba may be worth discussing with
                a clinician. Meanwhile, the approval of semaglutide tablets has
                created a new oral GLP-1 pathway for eligible adults who want a
              ...
              <p>
                Healthwise360 can help UK users compare weight loss treatment
                prices, understand provider differences, and make safer
