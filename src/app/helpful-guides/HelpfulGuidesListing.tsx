...
type Props = {
  activeCategorySlug?: HelpfulGuideCategorySlug;
};

export default function HelpfulGuidesListing({
  activeCategorySlug,
}: Props) {
  const activeCategoryLabel = activeCategorySlug
    ? (HELPFUL_GUIDE_CATEGORIES.find((c) => c.slug === activeCategorySlug)
        ?.label as Category | undefined)
    : undefined;
